...
<body>
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo"><span>ANABELLE SOFTWARE SOLUTIONS</span></h1>
            <ul>
    ...
    <footer>
        <center> Copyright@2024 Developed by INDRAJA S (212222043003)</B> </center>
    </footer>
</body>
</html>
```
...
<body>
    ...
    <footer>
        <center> Copyright@2024 Developed by INDRAJA S (212222043003)</center>
    </footer>
</body>
</html>
```
...
<body background="image.webp">
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo"><span>ANABELLE SOFTWARE SOLUTIONS</h1>
            <ul>
                <li><a href="home.html"> Home </a></li>
                <li><a href="Products.html"> Products </a></li>
                <li><a href="persons.html"> People </a></li>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
		        ...
		        background-image: url("pics/backgroundex7.jpeg");
                background-size: cover;
            }
            .navbar {
                width: 100%;
...
<body background="C:\Users\Admin\Desktop\ex 7 indhu\pics\backgroundex7.jpeg">
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p><span> Address</span>: <br> NO 11,LAKE AREA, 6TH CROSS STREET, NUNGAMBAKKAM, CHENNAI Chennai TN IN 600034. </p>
                <p> <span>Email</span> :<br> annabellesoftwaresolutions@gmail.com
